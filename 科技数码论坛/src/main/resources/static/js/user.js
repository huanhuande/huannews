define(function(require, exports, module) {
	...
	var _this = this;
	var rewardHtml = '<form id="form_reward" novalidate="novalidate"><dl><dt>大爷们赏了<span>0</span>积分</dt><dd class="input-radio"><div style="width:0;height:0;overflow:hidden"><input type="text" name="id" value="" /><input type="text" name="fee" value="5" /></div><span data-id="5" class="hover">5积分</span><span data-id="10">10积分</span><span data-id="20">20积分</span><span data-id="30">30积分</span><span data-id="40">40积分</span><span data-id="50">50积分</span></dd><dd class="message"></dd><dd class="input-btn"> <input type="button" class="reward-submit" value="打赏" /> <input type="button" class="reward-close" value="取消" /></dd> </dl></form>';
	var buyHtml = '<form id="form_buy_box" novalidate="novalidate"><div style="width:0;height:0;overflow:hidden"><input type="text" name="id" value="" /></div><p class="title">包养我吧！只需<span>200</span>积分哦！</p><p class="title">以后再赚钱就是你的了</p><p class="buy_error_message"></p> <p class="input-btn"><input type="button" class="reward-submit" value="确定" /><input type="button" class="reward-close" value="取消" /></p></form>';
	...
	reward.click(function() {
		...
		function() {
			...
			App.request({url:'/ajax/award',data: data,loading: false,success: function(result) {var re = result;if (re.err) {self.attr('class', 'rewarded').html('已打赏');App.alert('打赏成功，花费' + data.fee + '积分！');} else {App.alert(re.msg);};
